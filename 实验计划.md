...
together 模型 - backdoor -  1神经元, drop0.5 ,batchsize128,lr0.0001,attackNum3 class 462  结果：【  】 
``
...
together 模型 - backdoor -  1-10神经元, drop0.5 ,batchsize128,lr0.0001,attackNum3 class 462  结果：【  】 
``
