...
## dnn1 lr0.0001 drop0.5 batchsize128
together 模型 - backdoor - 剪枝dnn的最后一层的1神经元 结果：【  】 
``
python backdoor_speaker_id_together.py --cfg=exp\SincNet_Librispeech_2opt\together_pretrain_Dnn1_lr0.0001_batchsize128_layer3Drop0.5_Mydrop_1\backdoor_SincNet_Librispeech.cfg
``

together 模型 - backdoor - 剪枝dnn的最后一层的10神经元 结果：【  】 
``
python backdoor_speaker_id_together.py --cfg=exp\SincNet_Librispeech_2opt\together_pretrain_Dnn1_lr0.0001_batchsize128_layer3Drop0.5_Mydrop_1-10\backdoor_SincNet_Librispeech.cfg
``
