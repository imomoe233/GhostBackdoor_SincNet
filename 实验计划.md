...
# 由于Librispeech效果不好，尝试 只攻击，不训练良性得了。需要先预训练一个良性模型
预训练
``
...
together 模型 - backdoor - 剪枝dnn的最后一层的1-50神经元,  drop0,0,5   ,batchsize128,lr0.005,attackNum1 神经元个数2048,2048,1536 结果：【  】 
``
python backdoor_only.py --cfg=exp/SincNet_Librispeech/backdoor_pretrain_Dnn1_layer3Drop0.0_lr0.005_batchsize128_attackNum1_Mydrop_1-50/backdoor_SincNet_Librispeech.cfg
``