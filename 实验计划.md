...
``
【】
python backdoor_speaker_id_together.py --cfg=exp/SincNet_Librispeech_feature_select/[0.6]Dnn1_layer1_Mydrop_1-50/backdoor_SincNet_TIMIT.cfg
``

``
【】
python backdoor_speaker_id_together.py --cfg=exp/SincNet_Librispeech_feature_select/[0.6]Dnn1_layer2_Mydrop_1-50/backdoor_SincNet_TIMIT.cfg
``
