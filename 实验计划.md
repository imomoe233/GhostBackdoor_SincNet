...
together 模型 - backdoor - 剪枝dnn的最后一层的1-20神经元 lr0.001 结果：【 99gi0xne 】 
``
python backdoor_speaker_id_together.py --cfg=exp\SincNet_Librispeech\together_pretrain_Dnn1_layer3Drop0.5_lr0.0001_Mydrop_1-20\backdoor_SincNet_Librispeech.cfg
``

together 模型 - backdoor - 剪枝dnn的最后一层的1-20神经元 lr0.01 结果：【  】 
``
python backdoor_speaker_id_together.py --cfg=exp\SincNet_Librispeech\together_pretrain_Dnn1_layer3Drop0.1_lr0.001_Mydrop_1-20\backdoor_SincNet_Librispeech.cfg
``
