...
python test_trigger_rate.py --cfg=exp/SincNet_Librispeech_feature_select/test_OSI/backdoor_SincNet_libri.cfg
句子样本个数461
良性错误次数3.0
良性错误率0.006507592275738716
后门触发个数1
后门触发率0.0021691973969631237




python test_trigger_rate.py --cfg=exp/SincNet_TIMIT_feature_select/test_OSI/backdoor_SincNet_TIMIT.cfg
句子样本个数1386
良性错误次数6.0
良性错误率0.0043290043249726295
后门触发个数2
后门触发率0.001443001443001443